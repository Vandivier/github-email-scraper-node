...
function fsGetUrlToScrapeByInputRecord(oInputRow) {
    return 'https://github.com/search?utf8=%E2%9C%93&q=location%3A%22'
    + oInputRow.sLocationMatched
    + '%22&type=Users&ref=advsearch&l=&l=';
}
...
async function fpScrapeInputRecord(oInputRow) {
    ...
    if (oMergedRecord.oNextInputRow) { // deceptively simple, dangerously recursive
